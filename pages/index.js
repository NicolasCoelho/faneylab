  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="Digital Agency, We help your business to grow, Let our experts bring success business, Boost your brand with these key features, Business Plan Services, Contact Us"></meta>
        <meta name="description" content="Digital Agency with fair price to expand your business. Social media management and web site development."></meta>
      ...
      <header className="u-clearfix u-header u-sticky u-header" id="sec-3cd6">
            ...
            <div className="u-layout-row">
              ...
              <div
                ...
                <div className="u-container-layout u-container-layout-2">
                  <h5 className="u-text u-text-palette-1-base u-text-1">about us</h5>
                  ...
                  <div
                    ...
                    <div className="u-container-style u-expanded-width u-group u-palette-1-base u-group-1">
                      <div className="u-container-layout u-valign-middle-sm u-valign-middle-xl u-container-layout-2"><span
                        ...
                        <p className="u-text u-text-1">Our team comes to your rescue in order to help you cope with this state
                          of confusion. We take care of everything that you need to build an unshakable and strong presence
                          for your brand in this new digital world.</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="u-clearfix u-section-3" id="carousel_4d74">
        <div className="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-xs u-sheet-1">
          ...
          <p class ="u-text u-text-5"> We are specialized in creating digital presence for our costumers. We
          believe a good first impression is essential to anyone who's bringing their work to social media.
          Our experts have been trained to deliver the best in these three pillars.</p>
          </div>
          </div>
          </div>
          </div>
      ...
      <section className="u-align-center u-clearfix u-palette-1-base u-valign-middle-lg u-valign-middle-xl u-section-5"
        id="carousel_cc5b">
        <h4 className="u-align-left u-text u-text-palette-1-light-2 u-text-1">Features</h4>
        <h1 className="u-align-left u-text u-text-2">Boost your brand with these key features</h1>
          ...
          <div className="u-repeater u-repeater-1">
            <div
              ...
              <div className="u-container-layout u-similar-container u-container-layout-1"><span
                ...
                <h4 className="u-text u-text-palette-1-base u-text-3">social Media</h4>
                <p className="u-text u-text-palette-1-base u-text-4">Instagram and Facebook creation and management.</p>
              </div>
            </div>
            <div
              ...
              <div className="u-container-layout u-similar-container u-container-layout-2"><span
                ...
                <h4 className="u-text u-text-palette-1-base u-text-5">Web site<br></br>
                </h4>
                <p className="u-text u-text-palette-1-base u-text-6">Development with the best tools<br></br>
                </p>
              </div>
            </div>
            <div
              ...
              <div className="u-container-layout u-similar-container u-container-layout-3"><span
                ...
                <h4 className="u-text u-text-palette-1-base u-text-7">Marketing</h4>
                <p className="u-text u-text-palette-1-base u-text-8">We can help you to boost engagement with your visitors by
                  ensuring that people have access to the information that they want</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="u-layout">
              <div className="u-layout-row">
                ...
                <div className="u-align-left u-container-style u-layout-cell u-size-34 u-layout-cell-2">
                  <div className="u-container-layout u-container-layout-2">
                    <h2 className="u-text u-text-1">Web site Creation</h2>
                    <p className="u-text u-text-2">Imagine having your own website. Surely our developers could create and
                      maintain your services running with the modern tools on the market.<br></br>
                    </p>
        ...
        <div className="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xl u-valign-middle-xs u-sheet-1">
          <div className="u-align-center u-container-style u-expanded-width-sm u-expanded-width-xs u-group u-white u-group-1">
            <div className="u-container-layout u-valign-middle-lg u-valign-middle-xl u-valign-top-xs u-container-layout-1">
              <h2 className="u-text u-text-palette-1-base u-text-1">Contact Us</h2>
              <div className="u-align-left u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                <form action="api/contact" method="POST" className="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form"
                  ...
                  <div className="u-align-center u-form-group u-form-submit u-form-group-4">
                    <a href="#"
                      className="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">Submit</a>
                    <input type="submit" value="submit" className="u-form-control-hidden" wfd-invisible="true"></input>
                  </div>
                  <div className="u-form-send-message u-form-send-success" wfd-invisible="true"> Thank you! Your message has
                    been sent. </div>
                  <div className="u-form-send-error u-form-send-message" wfd-invisible="true"> Unable to send your message.
            ...
            <div className="u-repeater u-repeater-1">
              ...
              <div className="u-container-style u-list-item u-palette-2-light-2 u-repeater-item u-list-item-2">
                <div
                  ...
                  <h5 className="u-text u-text-4">Business Hours</h5>
                  <p className="u-text u-text-5">Mon – Fri | 10 am – 8 pm, Sat, Sun | Closed</p>
                </div>
              </div>
            </div>
          </div>
